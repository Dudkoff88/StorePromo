...
class ShopTableViewController: UITableViewController {
    ...
    let shops:[Shop] = [Shop(name: "Алми", image: "almi", logo: "almi", url: "http://almi.su/rb/90.html"),
                        Shop(name: "Гиппо", image: "gippo", logo: "almi", url: "http://gippo.by/ru/clients/specoffers/"),
                        Shop(name: "Евроопт", image: "euroopt", logo: "almi", url: "http://evroopt.by/tovary-v-magazinah-evroopt"),
                        Shop(name: "Корона", image: "korona", logo: "almi", url: "http://www.korona.by/minsk/gipper/actions/"),
                        Shop(name: "Рублевский", image: "rublevski", logo: "almi", url: "http://www.rublevski.by/images/phocagallery/action.pdf"),
                        ]
            ...
            if let indexPath = tableView.indexPathForSelectedRow {
                let destinationViewController = segue.destinationViewController as! TabController
                  let detailViewController = destinationViewController.viewControllers![0] as! DetailViewController
                   detailViewController.shop = shops[indexPath.row]
            }
        }
    }
